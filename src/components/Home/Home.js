  ...
  return (
    <div className="Home__container padding-top-60px">
      ...
      <section className="Home__buttons">
        <button 
          className="btn margin-bottom-10px"
          onClick={() => history.push('/create-account')}>Create seller account</button>
        <button
          className="btn" 
          onClick={() => history.push('/restaurant/1')}>Continue as a pizza buyer</button>
      </section>
    </div>
  )
}
